# GAP-ROUND-373 — 本地采集器实弹抽查（纯文档）

Round 373. Driver dimension: local collector live-fire spot
check (Claude Code / Codex / Gemini on-box state
determination), first since round-362. Stamped fixtures
(`r373-<epoch>`), agent+stamp double filter, explicit cleanup.
