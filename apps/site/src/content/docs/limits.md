...
| Codex CLI | `~/.codex/sessions/**/rollout-*.jsonl` (read-only) | lifecycle events + unresolved approval requests | **heuristic**, **authoritative** turn-complete with [notify hook](/hooks/) |
| Devin | `api.devin.ai/v1/sessions` | `status_enum === "blocked"` | **authoritative** |
