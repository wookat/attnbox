...
<CardGrid stagger>
  ...
  <Card title="Mobile-first PWA" icon="phone">
    ...
    notifications the moment an agent starts waiting on you — or point
    <code>ATTNBOX_WEBHOOK_URL</code> at your own channel (ntfy, Slack) for
    alerts that work with the inbox closed.
  </Card>
